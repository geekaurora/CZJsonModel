...
<html lang='zh-CN'>
<head>
<title>lesson02/HelloOS/main.c · LMOS/极客时间-操作系统实战45讲 - Gitee</title>
...
<meta content='https://gitee.com/lmos/cosmos/blob/master/lesson02/HelloOS/main.c' property='og:url'>
<meta content='https://gitee.com/static/images/logo_themecolor.png' itemprop='image' property='og:image'>
<meta content='lesson02/HelloOS/main.c · LMOS/极客时间-操作系统实战45讲 - Gitee' itemprop='name' property='og:title'>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function(event) {
    ...
    wx.config({
      ...
      timestamp: "1680489193",
      nonceStr: "7b0406c544353f4d336f6ca730cfc7bb",
      signature: "d594a1cd401f0a468b12d7c4ccb75f29cc924585",
      jsApiList: [
        'onMenuShareTimeline',
    ...
    wx.ready(function () {
      wx.onMenuShareTimeline({
        title: title, // 分享标题
        link: "https://gitee.com/lmos/cosmos/blob/master/lesson02/HelloOS/main.c", // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
        imgUrl: imgUrl // 分享图标
      });
...
<script>
  ...
  var title_form_authenticity_token = "yYHWTSAVC8wXx7HHiWeeU/0B3w801+FzZSl6Ram3AqraEMey45M9CYYBhVQ3PkoEPKD/1Gn4oaTIdrmhpyP1AQ==";
...
<script>
  ...
  if (false) {
    gon.project_new_blob_path = "/lmos/cosmos/new/master/lesson02/HelloOS/main.c"
    bindShowModal({
...
<input type="hidden" name="path" id="path" value="lesson02/HelloOS/main.c" />
...
<i class='iconfont icon-clone' data-clipboard-text='lesson02/HelloOS/main.c' id='btn-copy-file-path'></i>
</div>
<style>
  #btn-copy-file-path {
...
<span class='file_name' title='main.c'>
main.c
</span>
<small>95 Bytes</small>
</div>
...
<a class="ui button edit-blob" title="Please login" href="/lmos/cosmos/edit/master/lesson02/HelloOS/main.c">Edit</a>
<a class="ui button web-ide" target="_blank" href="/-/ide/project/lmos/cosmos/edit/master/-/lesson02/HelloOS/main.c">Web IDE</a>
<a class="ui button edit-raw" target="_blank" href="/lmos/cosmos/raw/master/lesson02/HelloOS/main.c">Raw</a>
<a class="ui button edit-blame" href="/lmos/cosmos/blame/master/lesson02/HelloOS/main.c">Blame</a>
<a class="ui button edit-history" href="/lmos/cosmos/commits/master/lesson02/HelloOS/main.c">History</a>
</div>
<script>
  "use strict";
  try {
...
<div class='line-numbers'><a href='#L1' id='L1'>1</a><a href='#L2' id='L2'>2</a><a href='#L3' id='L3'>3</a><a href='#L4' id='L4'>4</a><a href='#L5' id='L5'>5</a><a href='#L6' id='L6'>6</a><a href='#L7' id='L7'>7</a></div><div class="highlight markdown-code-block"><pre class=""><div class='line' id='LC1'><span class="c1">//彭东 @ 2021.01.09</span>&#x000A;</div><div class='line' id='LC2'><span class="cp">#include</span> <span class="cpf">"vgastr.h"</span>&#x000A;</div><div class='line' id='LC3'><span class="kt">void</span> <span class="nf">main</span><span class="p">()</span>&#x000A;</div><div class='line' id='LC4'><span class="p">{</span>&#x000A;</div><div class='line' id='LC5'>    <span class="n">printf</span><span class="p">(</span><span class="s">"Hello OS!"</span><span class="p">);</span>&#x000A;</div><div class='line' id='LC6'>    <span class="k">return</span><span class="p">;</span>&#x000A;</div><div class='line' id='LC7'><span class="p">}</span>&#x000A;</div></pre><div class="markdown-code-block-copy-btn"></div></div></div>
</div>
<script>
