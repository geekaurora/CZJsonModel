...
<html lang='zh-CN'>
<head>
<title>lesson02/HelloOS/vgastr.c · LMOS/极客时间-操作系统实战45讲 - Gitee</title>
...
<meta content='https://gitee.com/lmos/cosmos/blob/master/lesson02/HelloOS/vgastr.c' property='og:url'>
<meta content='https://gitee.com/static/images/logo_themecolor.png' itemprop='image' property='og:image'>
<meta content='lesson02/HelloOS/vgastr.c · LMOS/极客时间-操作系统实战45讲 - Gitee' itemprop='name' property='og:title'>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function(event) {
    ...
    wx.config({
      ...
      timestamp: "1680489199",
      nonceStr: "9befe611696e8c1503b7eb17d1e15c45",
      signature: "6a103d5b32399f7319b61f8bcd483a371d2232ac",
      jsApiList: [
        'onMenuShareTimeline',
    ...
    wx.ready(function () {
      wx.onMenuShareTimeline({
        title: title, // 分享标题
        link: "https://gitee.com/lmos/cosmos/blob/master/lesson02/HelloOS/vgastr.c", // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
        imgUrl: imgUrl // 分享图标
      });
...
<script>
  ...
  var title_form_authenticity_token = "14pB00nUyeE/xtzPbmNNKjqu0IJHdKPrnV193724fg7EG1AsilL/JK4A6FzQOpl9+w/wWRpb4zwwAr47syyJpQ==";
...
<script>
  ...
  if (false) {
    gon.project_new_blob_path = "/lmos/cosmos/new/master/lesson02/HelloOS/vgastr.c"
    bindShowModal({
...
<input type="hidden" name="path" id="path" value="lesson02/HelloOS/vgastr.c" />
...
<i class='iconfont icon-clone' data-clipboard-text='lesson02/HelloOS/vgastr.c' id='btn-copy-file-path'></i>
</div>
<style>
  #btn-copy-file-path {
...
<span class='file_name' title='vgastr.c'>
vgastr.c
</span>
<small>259 Bytes</small>
</div>
...
<a class="ui button edit-blob" title="Please login" href="/lmos/cosmos/edit/master/lesson02/HelloOS/vgastr.c">Edit</a>
<a class="ui button web-ide" target="_blank" href="/-/ide/project/lmos/cosmos/edit/master/-/lesson02/HelloOS/vgastr.c">Web IDE</a>
<a class="ui button edit-raw" target="_blank" href="/lmos/cosmos/raw/master/lesson02/HelloOS/vgastr.c">Raw</a>
<a class="ui button edit-blame" href="/lmos/cosmos/blame/master/lesson02/HelloOS/vgastr.c">Blame</a>
<a class="ui button edit-history" href="/lmos/cosmos/commits/master/lesson02/HelloOS/vgastr.c">History</a>
</div>
<script>
  "use strict";
  try {
...
<div class='line-numbers'><a href='#L1' id='L1'>1</a><a href='#L2' id='L2'>2</a><a href='#L3' id='L3'>3</a><a href='#L4' id='L4'>4</a><a href='#L5' id='L5'>5</a><a href='#L6' id='L6'>6</a><a href='#L7' id='L7'>7</a><a href='#L8' id='L8'>8</a><a href='#L9' id='L9'>9</a><a href='#L10' id='L10'>10</a><a href='#L11' id='L11'>11</a><a href='#L12' id='L12'>12</a><a href='#L13' id='L13'>13</a><a href='#L14' id='L14'>14</a><a href='#L15' id='L15'>15</a><a href='#L16' id='L16'>16</a><a href='#L17' id='L17'>17</a><a href='#L18' id='L18'>18</a><a href='#L19' id='L19'>19</a></div><div class="highlight markdown-code-block"><pre class=""><div class='line' id='LC1'><span class="c1">//彭东 @ 2021.01.09</span>&#x000A;</div><div class='line' id='LC2'>&#x000A;</div><div class='line' id='LC3'><span class="kt">void</span> <span class="nf">_strwrite</span><span class="p">(</span><span class="kt">char</span><span class="o">*</span> <span class="n">string</span><span class="p">)</span>&#x000A;</div><div class='line' id='LC4'><span class="p">{</span>&#x000A;</div><div class='line' id='LC5'>    <span class="kt">char</span><span class="o">*</span> <span class="n">p_strdst</span> <span class="o">=</span> <span class="p">(</span><span class="kt">char</span><span class="o">*</span><span class="p">)(</span><span class="mh">0xb8000</span><span class="p">);</span>&#x000A;</div><div class='line' id='LC6'>    <span class="k">while</span> <span class="p">(</span><span class="o">*</span><span class="n">string</span><span class="p">)</span>&#x000A;</div><div class='line' id='LC7'>    <span class="p">{</span>&#x000A;</div><div class='line' id='LC8'>&#x000A;</div><div class='line' id='LC9'>        <span class="o">*</span><span class="n">p_strdst</span> <span class="o">=</span> <span class="o">*</span><span class="n">string</span><span class="o">++</span><span class="p">;</span>&#x000A;</div><div class='line' id='LC10'>        <span class="n">p_strdst</span> <span class="o">+=</span> <span class="mi">2</span><span class="p">;</span>&#x000A;</div><div class='line' id='LC11'>    <span class="p">}</span>&#x000A;</div><div class='line' id='LC12'>    <span class="k">return</span><span class="p">;</span>&#x000A;</div><div class='line' id='LC13'><span class="p">}</span>&#x000A;</div><div class='line' id='LC14'>&#x000A;</div><div class='line' id='LC15'><span class="kt">void</span> <span class="nf">printf</span><span class="p">(</span><span class="kt">char</span><span class="o">*</span> <span class="n">fmt</span><span class="p">,</span> <span class="p">...)</span>&#x000A;</div><div class='line' id='LC16'><span class="p">{</span>&#x000A;</div><div class='line' id='LC17'>    <span class="n">_strwrite</span><span class="p">(</span><span class="n">fmt</span><span class="p">);</span>&#x000A;</div><div class='line' id='LC18'>    <span class="k">return</span><span class="p">;</span>&#x000A;</div><div class='line' id='LC19'><span class="p">}</span>&#x000A;</div></pre><div class="markdown-code-block-copy-btn"></div></div></div>
</div>
<script>
