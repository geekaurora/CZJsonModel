...
<html lang='zh-CN'>
<head>
<title>lesson02/HelloOS/vgastr.h · LMOS/极客时间-操作系统实战45讲 - Gitee</title>
...
<meta content='https://gitee.com/lmos/cosmos/blob/master/lesson02/HelloOS/vgastr.h' property='og:url'>
<meta content='https://gitee.com/static/images/logo_themecolor.png' itemprop='image' property='og:image'>
<meta content='lesson02/HelloOS/vgastr.h · LMOS/极客时间-操作系统实战45讲 - Gitee' itemprop='name' property='og:title'>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function(event) {
    ...
    wx.config({
      ...
      timestamp: "1680489205",
      nonceStr: "f68dd80034abbeddf4553e4bc41bad4b",
      signature: "e6fc76baad62d2fdd35eb962cd5e60e908f124b9",
      jsApiList: [
        'onMenuShareTimeline',
    ...
    wx.ready(function () {
      wx.onMenuShareTimeline({
        title: title, // 分享标题
        link: "https://gitee.com/lmos/cosmos/blob/master/lesson02/HelloOS/vgastr.h", // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
        imgUrl: imgUrl // 分享图标
      });
...
<script>
  ...
  var title_form_authenticity_token = "5/7QvrJNrnp/MCApht7PGDyejtD1vkfg3aaSy/FG6Yz0b8FBccuYv+72FLo4hxtP/T+uC6iRBzdw+VEv/9IeJw==";
...
<script>
  ...
  if (false) {
    gon.project_new_blob_path = "/lmos/cosmos/new/master/lesson02/HelloOS/vgastr.h"
    bindShowModal({
...
<input type="hidden" name="path" id="path" value="lesson02/HelloOS/vgastr.h" />
...
<i class='iconfont icon-clone' data-clipboard-text='lesson02/HelloOS/vgastr.h' id='btn-copy-file-path'></i>
</div>
<style>
  #btn-copy-file-path {
...
<span class='file_name' title='vgastr.h'>
vgastr.h
</span>
<small>82 Bytes</small>
</div>
...
<a class="ui button edit-blob" title="Please login" href="/lmos/cosmos/edit/master/lesson02/HelloOS/vgastr.h">Edit</a>
<a class="ui button web-ide" target="_blank" href="/-/ide/project/lmos/cosmos/edit/master/-/lesson02/HelloOS/vgastr.h">Web IDE</a>
<a class="ui button edit-raw" target="_blank" href="/lmos/cosmos/raw/master/lesson02/HelloOS/vgastr.h">Raw</a>
<a class="ui button edit-blame" href="/lmos/cosmos/blame/master/lesson02/HelloOS/vgastr.h">Blame</a>
<a class="ui button edit-history" href="/lmos/cosmos/commits/master/lesson02/HelloOS/vgastr.h">History</a>
</div>
<script>
  "use strict";
  try {
...
<div class='line-numbers'><a href='#L1' id='L1'>1</a><a href='#L2' id='L2'>2</a><a href='#L3' id='L3'>3</a><a href='#L4' id='L4'>4</a></div><div class="highlight markdown-code-block"><pre class=""><div class='line' id='LC1'><span class="c1">//彭东 @ 2021.01.09</span>&#x000A;</div><div class='line' id='LC2'>&#x000A;</div><div class='line' id='LC3'><span class="kt">void</span> <span class="nf">_strwrite</span><span class="p">(</span><span class="kt">char</span><span class="o">*</span> <span class="n">string</span><span class="p">);</span>&#x000A;</div><div class='line' id='LC4'><span class="kt">void</span> <span class="nf">printf</span><span class="p">(</span><span class="kt">char</span><span class="o">*</span> <span class="n">fmt</span><span class="p">,</span> <span class="p">...);</span>&#x000A;</div></pre><div class="markdown-code-block-copy-btn"></div></div></div>
</div>
<script>
